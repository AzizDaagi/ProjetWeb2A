...
class ChatbotService
{
    ...
    private function resolveKeywordResponse($message, $userId)
    {
        ...
        if (preg_match('/(lipides?|gras|mati[eÃ¨]res?\s+grasses?)/ui', $message)) {
        ...
        if (preg_match('/(projection|prediction|pr[eÃ©]vision|date d[\' ]atteinte)/ui', $message)) {
    ...
    {
        return "Je nâ€™ai pas pu gÃ©nÃ©rer une rÃ©ponse avancÃ©e pour le moment, mais je peux tâ€™aider sur les calories, protÃ©ines, hydratation, objectifs, sucre ou projection nutritionnelle.";
    }
