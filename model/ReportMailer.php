...
class ReportMailer
{
    public function sendWeeklyReport(array $stats, ?string $to = null): array
    {
        ...
        $subject = "ðŸ“Š Rapport nutrition hebdomadaire";
        $htmlBody = "
              ...
              <table width=\"600\" cellpadding=\"0\" cellspacing=\"0\" style=\"width:600px; max-width:600px; font-family:Arial, sans-serif; color:#ffffff;\">
                ...
                <tr>
                  <td style=\"padding:20px 20px 14px 20px;\">
                    <h2 style=\"margin:0; color:#22c55e; font-size:26px; line-height:1.2;\">ðŸ“Š Rapport nutrition hebdomadaire</h2>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  <td style=\"padding:20px; font-size:15px; line-height:1.6;\">
                    ðŸ’¡ Continuez vos efforts ! Vous pouvez encore amÃ©liorer votre rÃ©gularitÃ© cette semaine ðŸ’ª
                  </td>
                </tr>
                <tr>
