...
try {
    ...
    $router->get('admin.prediction.panel', [ProductController::class, 'predictionPanel']);
    $router->post('admin.prediction.quick', [ProductController::class, 'formPredict']);
    $router->get('admin.prediction.predict', [ProductController::class, 'predictProductStats']);
    ...
    $router->get('admin.orders.debug', [CommandeController::class, 'debugPdf']);
    ...
    $router->get('admin.orders.pdf', [CommandeController::class, 'downloadAdminPdf']);
    ...
    $router->get('migrate.addBuyerEmail', [MigrationController::class, 'migrateAddBuyerEmail']);
