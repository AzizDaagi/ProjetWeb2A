<div class="container admin-dashboard">
    ...
    <div class="actions admin-actions">
        <a href="<?= htmlspecialchars(app_url('index.php?action=users-list')) ?>" class="btn">
            <i class="fa-solid fa-users"></i> Manage Users
        </a>
        <a href="<?= htmlspecialchars(app_url('index.php?action=recipes-management')) ?>" class="btn">
            <i class="fa-solid fa-book-open"></i> Manage Recipes
        </a>
        <a href="<?= htmlspecialchars(app_url('index.php?action=foods-management')) ?>" class="btn">
            <i class="fa-solid fa-apple-whole"></i> Manage Foods
        </a>
        <a href="<?= htmlspecialchars(app_url('index.php?action=recommendations-management')) ?>" class="btn">
