...
class AuthController
{
    ...
    {
        return '/smart_nutritionn/gestionActiviteesportive/index.php?action=' . $action;
    }
    ...
    public function forgotPassword()
    {
        ...
        header('Location: /smart_nutritionn/gestionActiviteesportive/index.php?action=reset-password&email=' . urlencode($email));
        exit;
    }
