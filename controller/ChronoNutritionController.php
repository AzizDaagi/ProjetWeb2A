...
class ChronoNutritionController {
    ...
    public function chrono_nutrition() {
        ...
        $additionalStylesheets = ['/Web/view/front/assets/css/chrono-nutrition.css?v=' . filemtime($chronoStylesheet)];
        $additionalScripts = ['/Web/view/front/assets/js/chrono-nutrition.js?v=' . filemtime($chronoScript)];
