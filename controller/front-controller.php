...
require_once $projectRoot . '/controller/UserController.php';
require_once $projectRoot . '/controller/WeatherController.php';
...
if ($action === 'home') {
    ...
    include $projectRoot . '/view/front/home.php';
    ...
    include $projectRoot . '/view/layouts/header.php';
    include $projectRoot . '/view/front/modules/auth-management.php';
    include $projectRoot . '/view/layouts/footer.php';
