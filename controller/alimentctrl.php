...
require_once __DIR__ . '/../model/ReportMailer.php';
...
class alimentctrl
{
    ...
    public function index()
    {
        ...
        require __DIR__ . '/../view/front/aliments/index.php';
    }
    ...
    {
        // Official view entrypoint for the custom food + USDA autofill flow.
        require __DIR__ . '/../view/front/aliments/create_custom.php';
    }
    ...
    {
        // Official JSON route: index.php?action=nutrition_usda_lookup
        // Official controller for USDA lookup: controller/alimentctrl.php
        if (strtoupper((string) ($_SERVER['REQUEST_METHOD'] ?? 'GET')) !== 'POST') {
            $this->errorJson("Methode non autorisee.", 405);
        }
        ...
        if ($result['error'] !== null) {
            $this->errorJson(
                ...
                400,
                [
                    'debug_usda' => $result['debug_usda'] ?? null,
                ]
            );
        }
    ...
    public function edit()
    {
        ...
        require __DIR__ . '/../view/front/aliments/edit.php';
    }
    ...
    private function validateCustomAlimentInput($data)
    {
        ...
        if (!is_numeric($sucre) || (float) $sucre < 0) {
    ...
    private function errorJson($message, $statusCode = 400, array $extra = [])
    {
