<div class="container">
    ...
    <form method="POST" action="<?= htmlspecialchars(app_url('index.php?action=register')) ?>">
        <div class="field">
    ...
    <p class="link-text">Already registered? <a href="<?= htmlspecialchars(app_url('index.php?action=login')) ?>">Sign in</a></p>
</div>
