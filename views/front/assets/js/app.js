...
function initThemeToggle() {
    if (window.SmartNutritionTheme && typeof window.SmartNutritionTheme.init === 'function') {
        window.SmartNutritionTheme.init();
        return;
    }
    ...
    try {
        ...
        if (savedTheme !== 'light' && savedTheme !== 'dark') {
            savedTheme = localStorage.getItem(oldStorageKey);
        }
    } catch (error) {
        savedTheme = null;
    }
...
function applyTheme(theme, storageKey) {
    ...
    try {
        ...
        localStorage.setItem('smartNutritionTheme', isDark ? 'dark' : 'light');
    } catch (error) {
