...
<div class="admin-shell">
    <aside class="admin-sidebar">
        <div class="admin-brand">
            <a href="/smart_nutrition/#?action=admin-dashboard" class="admin-brand-link">
                <img
        ...
        <div class="admin-menu-section">
            ...
            <a href="/smart_nutrition/#?action=admin-dashboard" class="admin-side-link">
                <i class="fa-solid fa-gauge-high"></i>
                <span>Dashboard</span>
            </a>
            <a href="/smart_nutrition/#?action=users-list" class="admin-side-link">
        ...
        <div class="admin-menu-section admin-modules-section">
            ...
            <button
                type="button"
                class="admin-side-link admin-module-btn"
            ...
            <div id="adminModuleDescription" class="admin-module-description" tabindex="-1">
                <strong id="adminModuleDescriptionTitle"></strong>
                <p id="adminModuleDescriptionText"></p>
            </div>
        </div>
    </aside>
    ...
    <header class="admin-topbar">
        <div class="admin-top-actions">
            ...
            <a href="/smart_nutrition/#?action=logout" class="admin-logout-btn" title="Deconnexion">
