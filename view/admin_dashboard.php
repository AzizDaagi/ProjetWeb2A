...
<div class="animate-fade-in">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
        ...
        <div>
            ...
            <a href="index.php?action=logout" class="btn" style="background: var(--error);">Déconnexion</a>
        </div>
    </div>
            ...
            <?php foreach($activites as $act): ?>
                <div class="glass-card">
                    ...
                    <div style="display: flex; gap: 0.5rem;">
                        ...
                        <a href="index.php?action=deleteActivite&id=<?= $act['id_activite'] ?>" class="btn btn-outline" style="flex: 1; text-align: center; padding: 0.5rem; font-size: 0.85rem; border-color: var(--error); color: var(--error);">�??? Supprimer</a>
                    </div>
                </div>
            <?php endforeach; ?>
        <?php endif; ?>
