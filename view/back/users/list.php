<div class="container admin-dashboard users-list-page admin-page" data-users-search-endpoint="/Web/index.php?action=users-search">
    ...
    <div class="users-tools">
        ...
        <div class="users-tools-meta">
            ...
            <a href="/Web/index.php?action=create-user" class="btn-admin">
                ...
                <?php if (!empty($users)): ?>
                    ...
                    <tr data-user-row>
                        ...
                        <td class="users-actions">
                            <a href="/Web/index.php?action=edit-user&id=<?= $u['id'] ?>" class="btn-edit">
                                <i class="fa-solid fa-pen"></i> Modifier
                            </a>
                            <form method="POST" action="/Web/index.php?action=delete-user" class="inline-form" onsubmit="return confirm('Supprimer cet utilisateur ?');" novalidate>
    ...
    <a href="/Web/index.php?action=profile" class="btn-admin-secondary">Retour au profil</a>
</div>
