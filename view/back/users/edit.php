<div class="container admin-page admin-form-page">
    ...
    <form method="POST" action="/smart_nutritionn/gestionActiviteesportive/index.php?action=update-user" novalidate>
    ...
    <div class="actions">
        <a href="/smart_nutritionn/gestionActiviteesportive/index.php?action=users-list" class="btn secondary">Retour a la liste</a>
    </div>
</div>
