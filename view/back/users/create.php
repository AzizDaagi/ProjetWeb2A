...
<form method="POST" action="/projetwebmalek/index.php?action=store-user" novalidate>
        <div class="field">
    ...
    <div class="actions">
<a href="/projetwebmalek/index.php?action=users-list" class="btn-admin-secondary">Retour a la liste</a>
    </div>
</div>
