<div class="container admin-page admin-form-page">
    ...
    <form method="POST" action="/smart_nutritionn/gestionActiviteesportive/index.php?action=store-user" novalidate>
        <div class="field">
    ...
    <div class="actions">
        <a href="/smart_nutritionn/gestionActiviteesportive/index.php?action=users-list" class="btn-admin-secondary">Retour a la liste</a>
    </div>
</div>
