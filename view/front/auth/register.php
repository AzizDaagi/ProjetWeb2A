...
<form method="POST" action="/projetwebmalek/index.php?action=register" novalidate>
        <div class="field">
...
<p class="link-text">Deja inscrit ? <a href="/projetwebmalek/index.php?action=login">Se connecter</a></p>
</div>
