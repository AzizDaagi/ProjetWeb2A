...
<div class="container">
    ...
    <form method="POST" action="/smart_nutritionn/gestionActiviteesportive/index.php?action=register" novalidate>
        <div class="field">
    ...
    <p class="link-text">Deja inscrit ? <a href="/smart_nutritionn/gestionActiviteesportive/index.php?action=login">Se connecter</a></p>
</div>
