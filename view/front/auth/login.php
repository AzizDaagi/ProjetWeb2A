...
<div class="container">
    ...
    <form method="POST" action="/smart_nutritionn/gestionActiviteesportive/index.php?action=login" novalidate id="passwordLoginForm">
        <div class="field">
        ...
        <div class="login-actions">
            ...
            <a class="btn btn-link forgot-link" href="/smart_nutritionn/gestionActiviteesportive/index.php?action=forgot">Mot de passe oubli&eacute; ?</a>
        </div>
    </form>
    ...
    <section
        ...
        data-endpoint="/smart_nutritionn/gestionActiviteesportive/index.php?action=face-login"
    >
    ...
    <p class="link-text">Pas encore de compte ? <a href="/smart_nutritionn/gestionActiviteesportive/index.php?action=register">S'inscrire</a></p>
</div>
...
if (config && loginButton && statusEl) {
    ...
    loginButton.addEventListener('click', async () => {
        ...
        try {
            ...
            const response = await fetch('/smart_nutritionn/gestionActiviteesportive/index.php?action=google-login', {
                method: 'POST',
                headers: {
            ...
            window.location.href = payload.redirect || '/smart_nutritionn/gestionActiviteesportive/index.php?action=home';
        } catch (error) {
