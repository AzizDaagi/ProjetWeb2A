...
<div class="container">
    ...
    <form method="post" action="/smart_nutritionn/gestionActiviteesportive/index.php?action=reset-password">
        ...
        <div class="form-group">
            ...
            <a href="/smart_nutritionn/gestionActiviteesportive/index.php?action=login" class="btn btn-link">Retour</a>
        </div>
    </form>
</div>
