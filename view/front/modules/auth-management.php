<div class="container">
    ...
    <div class="actions">
    <a class="btn" href="/projetwebmalek/index.php?action=login">
            <i class="fa-solid fa-lock"></i> Connexion
        </a>
    <a class="btn" href="/projetwebmalek/index.php?action=register">
            <i class="fa-solid fa-user-plus"></i> Inscription
        </a>
    <a class="btn btn-accent" href="/projetwebmalek/index.php?action=logout">
