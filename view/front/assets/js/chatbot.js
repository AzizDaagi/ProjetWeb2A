document.addEventListener('DOMContentLoaded', function () {
  ...
  const welcomeMessage = "Bonjour, je peux rÃ©pondre rapidement sur les calories, les protÃ©ines, l'hydratation et quelques conseils nutritionnels simples.";
  ...
  (function initMascot() {
    ...
    const SPEECHES = {
      focus: "Hmmâ€¦ dis-moi tout, je t'Ã©coute ðŸ‘‚",
      typing: "Je lis ce que tu Ã©crisâ€¦",
      waiting: "Tu voulais me demander quelque chose ? ðŸ˜Š",
      sending: "Hmmâ€¦ laisse-moi analyser Ã§a pour toi ðŸ¤”",
      replyLocal: "VoilÃ  ! C'est ma spÃ©cialitÃ© ðŸ’ª",
      replyMistral: "J'ai demandÃ© Ã  Mistral pour toi ðŸ¤–",
      empty: "Ã‰cris quelque chose d'abord ! âœï¸",
      click: "Coucou ! Besoin d'un conseil nutrition ? ðŸ¥—",
      happy: "Super question ! ðŸŽ‰",
      calories: "Je vÃ©rifie tes calories du jour ðŸ”¥",
      proteines: "Les protÃ©ines, mon domaine ! ðŸ’ª",
      hydration: "Reste bien hydratÃ©(e) ! ðŸ’§",
      conseil: "Un conseil personnalisÃ© pour toi ðŸ’¡",
      statut: "Analyse de ton statut en coursâ€¦ ðŸ“Š"
    };

    const STATES = {
      idle: { badge: 'ðŸ˜Š En forme', mouth: 'M50 58 Q60 67 70 58', bL: 'M40 29 Q44 26 48 28', bR: 'M72 30 Q76 27 80 29' },
      happy: { badge: 'ðŸŽ‰ Super !', mouth: 'M48 56 Q60 68 72 56', bL: 'M40 27 Q44 23 48 25', bR: 'M72 25 Q76 23 80 27' },
      surprise: { badge: 'ðŸ˜² Surpris !', mouth: 'M52 57 Q60 68 68 57', bL: 'M40 25 Q44 21 48 23', bR: 'M72 23 Q76 21 80 25' },
      think: { badge: 'ðŸ¤” RÃ©flexion', mouth: 'M50 60 Q60 62 70 60', bL: 'M40 30 Q44 28 48 32', bR: 'M72 28 Q76 26 80 30' },
      shy: { badge: 'ðŸ™ˆ Timideâ€¦', mouth: 'M52 62 Q60 58 68 62', bL: 'M41 32 Q44 30 47 31', bR: 'M73 31 Q76 30 79 32' },
      wave: { badge: 'ðŸ‘‹ Bonjour !', mouth: 'M48 56 Q60 68 72 56', bL: 'M40 27 Q44 23 48 25', bR: 'M72 25 Q76 23 80 27' },
      shake: { badge: 'ðŸ˜¤ Non non !', mouth: 'M50 62 Q60 58 70 62', bL: 'M40 28 Q43 25 47 28', bR: 'M73 28 Q77 25 80 28' }
    };

    const QR_REACTIONS = {
      calories: { s: 'happy', parts: ['ðŸ”¥', 'âš¡', 'âœ¨'], sk: 'calories' },
      'protÃ©ines': { s: 'happy', parts: ['ðŸ’ª', 'â­', 'ðŸŽ¯'], sk: 'proteines' },
      hydratation: { s: 'wave', parts: ['ðŸ’§', 'ðŸŒŠ', 'âœ¨'], sk: 'hydration' },
      conseil: { s: 'think', parts: ['ðŸ’¡', 'ðŸŒŸ', 'âœ¨'], sk: 'conseil' },
      statut: { s: 'surprise', parts: ['ðŸ“Š', 'ðŸŽ‰', 'â­'], sk: 'statut' }
    };
    ...
    mascot.addEventListener('click', function () {
      ...
      const options = [
        { s: 'happy', sk: 'click', parts: ['â­', 'âœ¨', 'ðŸŒŸ'] },
        { s: 'wave', sk: 'happy', parts: ['ðŸ‘‹', 'ðŸŒŸ', 'âœ¨'] },
        { s: 'surprise', sk: 'click', parts: ['ðŸŽ‰', 'â­', 'âœ¨'] }
      ];
    ...
    // â”€â”€â”€ DEBUG VISUAL TEST â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    window.testMascotMotion = function () {
      ...
      if (!allOk) {
        console.warn('[testMascotMotion] Some elements are null â€” animation will be partial.');
      }

      // 2. Eyes â†’ SVG setAttribute (same path the tick loop uses)
      if (eyeL) { eyeL.setAttribute('cx', 49); eyeL.setAttribute('cy', 40); }
      if (eyeR) { eyeR.setAttribute('cx', 81); eyeR.setAttribute('cy', 40); }

      // 3. Body tilt â†’ CSS custom properties (same path the tick loop uses)
      if (mascot) {
      ...
      // 4. Arms â†’ cinematic wave class (same path replayArmWave uses)
      window.clearTimeout(armWaveResetTimer);
      ...
      console.info('[testMascotMotion] fired â€” watch the mascot for ~900 ms.');
    };
  ...
  clearButton.addEventListener('click', async function () {
    try {
      ...
      messages.innerHTML = '';
      showNotice('Conversation effacÃ©e âœ“');
    } catch (error) {
  ...
  form.addEventListener('submit', async function (event) {
    ...
    showNotice('Assistant en train de rÃ©pondre...');
    ...
    try {
      ...
      appendMessage(
        'bot',
        data.response || (response.ok ? "Je n'ai pas trouvÃ© de rÃ©ponse." : "Je n'ai pas pu traiter votre message."),
        data.source || 'local',
      ...
      typingNode.remove();
      botReplyHandledManually = true;
      appendMessage('bot', "Le service est momentanÃ©ment indisponible. Essayez une question plus simple ou revenez plus tard.", 'local', currentTime());
      if (typeof window.onBotReply === 'function') {
