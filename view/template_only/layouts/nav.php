<nav class="navbar">
    <div class="navbar-brand">
        <a href="/projet-web-25-26/index.php?action=recipes-management">
            <img
                src="/projet-web-25-26/view/template_only/2-removebg-preview.png"
                alt="Smart Nutrition"
                class="brand-logo"
    ...
    <ul class="navbar-menu">
        ...
        <li><a href="/projet-web-25-26/index.php?action=admin-aliments" class="nav-link">
            <i class="fa-solid fa-plus"></i> Submit Product
        </a></li>
        <li><a href="/projet-web-25-26/index.php?action=recipes-management" class="nav-link">
            <i class="fa-solid fa-book-open"></i> My Orders
        </a></li>
        <li><a href="/projet-web-25-26/index.php?action=recipe-generate" class="nav-link" style="color:#9b59b6;">
            <i class="fa-solid fa-wand-magic-sparkles"></i> Générateur IA
        </a></li>
        <li><a href="/projet-web-25-26/index.php?action=recipe-stats" class="nav-link" style="color:#3498db;">
        ...
        <li><a href="/projet-web-25-26/index.php?action=admin-recipes" class="nav-link">
            <i class="fa-solid fa-user-shield"></i> Admin Orders
        </a></li>
        <li><a href="/projet-web-25-26/index.php?action=admin-recommendations" class="nav-link">
