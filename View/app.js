...
function initHomeTopicButtons() {
    var buttons = document.querySelectorAll('.home-topic-btn');
    var titleEl = document.getElementById('homeTopicTitle');
    var textEl = document.getElementById('homeTopicText');
    var cardEl = document.getElementById('homeTopicDescription');

    if (!buttons.length || !titleEl || !textEl) {
        return;
    }
    ...
    function setActive(button) {
        ...
        titleEl.textContent = button.getAttribute('data-topic-title') || button.textContent.trim();
        textEl.textContent = button.getAttribute('data-topic-description') || '';
