    ...
    <div id="voiceControlDock" class="voice-control-dock" aria-live="polite">
        ...
        <div id="voiceControlPanel" class="voice-control-panel">
            ...
            <p id="voiceLastAction" class="voice-last-action">Exemples: "ouvre activites", "descendre", "cliquer deconnexion".</p>
        </div>
    </div>
    ...
    <script src="<?= $basePath ?>/View/app.js?v=<?= $assetVersion ?>"></script>
    <script src="<?= $basePath ?>/View/backoffice.js?v=<?= $assetVersion ?>"></script>
</body>
</html>
