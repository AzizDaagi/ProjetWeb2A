...
require_once __DIR__ . '/../model/PredictionModel.php';
...
class PredictionService
{
    ...
    private const BEHAVIORAL_OBJECTIVE_MESSAGE = "Projection de date non disponible pour les objectifs comportementaux comme la r̩duction du sucre.";
