...
{
    private const API_URL = 'https://router.huggingface.co/hf-inference/model/TinyLlama/TinyLlama-1.1B-Chat-v1.0';
    ...
    {
        // flan-t5 is a text2text model â€” direct question format works best
